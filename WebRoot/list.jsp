...
<body>
	...
	<table border="1" width="80%" align="center">
		...
		<s:iterator value="#request.list" id="ad">
			<tr>
				<td><s:property value="#ad.adminId"/></td>
				<td><s:property value="#ad.adminName"/></td>
				<td><s:property value="#ad.adminPassword"/></td>
				<td><s:property value="#ad.adminRole"/></td>
				<td><s:property value="#ad.adminRemark"/></td>
				<!-- %指定好，#在页面获得的id -->
